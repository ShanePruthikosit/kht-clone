...
class TestCheckValid:
    ...
    def test_correct_key_returns_true(self):
        ...
        mock_ctx = Mock()
        mock_ctx.eval.return_value = "abc123"
        _mock_execjs.compile.return_value = mock_ctx
        assert check_valid("12-30-00", "abc123") is True
    ...
    def test_wrong_key_returns_false(self):
        ...
        mock_ctx.eval.return_value = "abc123"
        _mock_execjs.compile.return_value = mock_ctx
        assert check_valid("12-30-00", "wrongkey") is False
    ...
    def test_empty_key_returns_false(self):
        ...
        mock_ctx.eval.return_value = "abc123"
        _mock_execjs.compile.return_value = mock_ctx
        assert check_valid("12-30-00", "") is False
    ...
    def test_case_sensitive(self):
        ...
        mock_ctx.eval.return_value = "ABC123"
        _mock_execjs.compile.return_value = mock_ctx
        assert check_valid("12-30-00", "abc123") is False
